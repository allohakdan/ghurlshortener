...
default_configfile = "links.ini"
default_githubpath = "allohakdan/links"
...
default_script_path = os.path.dirname(os.path.realpath(__file__))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default=default_configfile)
    parser.add_argument("--githubpath", type=str, default=default_githubpath)
    parser.add_argument("--path", type=str, default=default_script_path)
    parser.add_argument("--update-check", action="store_true")
    parser.add_argument("--dont-pull", action="store_true")

    args = parser.parse_args()
    config = args.config
    githubconfigurl = "https://raw.githubusercontent.com/" + args.githubpath + "/master/links.ini"
    path = args.path
    ...
    parser.read(os.path.join(path, args.configfile))
